<?php
    ...
    function email($to, $subject, $body)
    {
        ...
        // creat mail object and set some settings
        ...
        try
        {
            ...
            $mail->Port = 587; 
            $mail->Username = "cs50testemail@gmail.com";
            $mail->Password = "cs5012345";
            $mail->SetFrom('cs50testemail@gmail.com');
            $mail->AddAddress($to);
    ...
    function randompw()
    {
        ...
        for($i = 0; $i < 10; $i++)
        {
            $randompw .= $characters[rand(0,$charactersLen - 1)];
        }
